...
utilities.isDirectory = function (dir) {
  return fs.existsSync(dir) && fs.lstatSync(dir).isDirectory()
}

/**
 * judge path is absolute or not
 * @param {String} str
 * @returns {boolean}
 */
utilities.isAbsolutePath = function (str = '') {
  return str.indexOf('/') === 0
}

/**
 * is passed item a string
 * @param str
 * @returns {*|boolean}
 */
...
/**
 * is passed item a generator
 * @param fn
 * @returns {*|boolean}
 */
utilities.isGenerator = function (fn) {
  return fn && fn.constructor === generator.constructor
  function* generator () {}
}
...
utilities.hasJoiChildren = function (joiObj) {
  return !!(utilities.isJoi(joiObj) && Hoek.reach(joiObj, '_inner.children'))
}
...
utilities.hasJoiMeta = function (joiObj) {
  return utilities.isJoi(joiObj) && Array.isArray(joiObj._meta)
}
...
/**
 * turns a javascript object into JOI object
...
utilities.toJoiObject = function (obj) {
  if (utilities.isObject(obj) && !utilities.isJoi(obj)) {
...
/**
 * ensure an dir exists
 * @param path
 */
utilities.ensureDir = function (path) {
